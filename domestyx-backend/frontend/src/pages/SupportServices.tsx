...
const SupportServices = () => {
 ...
 <h1 className="text-2xl font-semibold text-app-text">Support Services</h1>
 ...
 <p className="font-medium text-app-text">#{r.id} · {r.service_type}</p>
 <p className="text-sm text-gray-600">Provider: {r.provider_name || r.provider}</p>
 ...
 <CardContent className="space-y-3">
 {!activeRequestId ? (
 <p className="text-sm text-gray-500">Select a request and open chat.</p>
 ) : (
 <>
